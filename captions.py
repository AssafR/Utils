# A replacement for the captions.py in the pytube library
# Based on the code from: https://stackoverflow.com/questions/68780808/xml-to-srt-conversion-not-working-after-installing-pytube
...
class Caption:
    ...
    def __init__(self, caption: pytube.captions.Caption):
        self.url = caption.url
        self.name = caption.name
        self.code = caption.code
